...
function ScorePage() {
  ...
  return (
    <div className='scorePage' >
        <div className="page-score-header" style={{ backgroundImage: `url(${banner})` }} >
            <div className="container">
                ...
                <div className="match-content">
                    ...
                    <div className="team-score-container">
                        <div className="team-name">
                            <div className="team-logo">
                                <img src={image1} alt="Sangam Challengers" />
                            </div>
                            <h2>SONIPAT STARS</h2>
                        </div>
                    ...
                    <div className="team-score-container">
                        ...
                        <div className="team-name">
                            <div className="team-logo">
                                <img src={image2} alt="Sangam Challengers" />
                            </div>
                            <h2>ROTHAK ROYALS</h2>
                        </div>
        ...
        <div className="fixtures-buttons-container container" style={{marginTop : '50px'}}>
              ...
              <button
                ...
                className={`${activeTab === 'playbyplay'
                    ? 'active'
                    : ''
                  }`}
              >
